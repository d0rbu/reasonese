...
pairs and writes 2,592 prompt specifications: 54 for each of the 48 instructions, using
Inkling, Inkling Small, and Gemma 4 31B as authors. The sampler defaults to those same three
